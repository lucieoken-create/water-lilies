...
// 25 pads in a 5-col × 5-row grid (row-major order).
...
const SLOTS = [
  ...
  { type: 'pink',  offX:   6, offY:  -6, rotation:  10, sx:  0.6, sy: -1   },
  ...
  { type: 'white', offX:  10, offY:  -8, rotation: -12, sx:  0.8, sy:  0.4 },
  ...
  { type: 'pad',   offX:   8, offY:  -8, rotation: -10, sx: -0.5, sy: -0.8 },
  // Row 3 — scatter mixed
  ...
  { type: 'pink',  offX:   8, offY:  -6, rotation:  12, sx:  0.7, sy:  0.6 },
  // Row 4 — scatter DOWN
  ...
  { type: 'white', offX:   6, offY:  -8, rotation: -14, sx:  0.5, sy:  1   },
]
...
export default function CurtainPad({ scattering, SVG_MAP }) {
  ...
  // 5 columns: centers at 5%, 27%, 50%, 73%, 95% of vw. Left edge = center − padW/2.
  // Col 0 bleeds off left, col 4 bleeds off right.
